            ...
            <div class="block">
              ...
              <div class="block__content">
                <div class="articles articles__horizontal">
                  ...
                  $total_pages = ceil($total_count / $per_page); // Всего страниц (округляем)
                ...
                if ($articles_exist == true)
                  {
                      ...
                      if ( $page > 1 )
                      {
                        echo '<a href="/article.php?page='.($page - 1).'">Прошлая страница</a>';
                      }
                      if ( $page < $total_pages )
                      {
                      echo '<a href="/article.php?page='.($page + 1).'">Следующая страница</a>';
                      }
                      echo '</div>';
                  }
                  ?>
